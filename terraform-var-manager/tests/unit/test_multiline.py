...
def test_format_var_line_with_mline() -> None:
...
def test_format_var_line_mline_with_sensitive() -> None:
    """Test multiline variable that is also sensitive."""
    multiline_value = "secret_content"

    result = format_var_line(
        "private_key", multiline_value, "credentials", sensitive=True, mline=True
    )
...
def test_format_var_line_mline_with_keep() -> None:
...
exit 0"""
    ...
    result = format_var_line(
        "startup_script", multiline_value, "scripts", keep=True, mline=True
    )
...
def test_group_and_format_vars_with_mline() -> None:
...
def test_multiline_with_json_content() -> None:
...
def test_multiline_with_yaml_content() -> None:
...
def test_multiline_empty_value() -> None:
...
def test_multiline_single_line() -> None:
